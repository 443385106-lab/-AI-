...
!ifndef OUTFILE
  !define OUTFILE "..\dist\JiangxinVectorStudio-1.5.0-Setup.exe"
!endif
...
VIAddVersionKey /LANG=2052 "FileVersion" "1.5.0"
...
Section "主程序" SecMain
  ...
  WriteRegStr HKLM "Software\Microsoft\Windows\CurrentVersion\Uninstall\JiangxinVectorStudio" "DisplayVersion" "1.5.0"
SectionEnd
