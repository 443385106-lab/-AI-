...
!ifndef OUTFILE
  !define OUTFILE "..\dist\JiangxinVectorStudio-1.1.0-Setup.exe"
!endif
...
Section "主程序" SecMain
  ...
  WriteRegStr HKLM "Software\Microsoft\Windows\CurrentVersion\Uninstall\JiangxinVectorStudio" "DisplayVersion" "1.1.0"
SectionEnd
