...
> 仓库已新增独立的 [`native/`](native/) 工程：**匠心矢量设计 1.3 Native**。它采用 C++20 与 Qt 6 自主开发，兼容专业图文设计工作流程，但不复制任何 CorelDRAW 专有代码、界面素材或 CDR 文件规范。1.3 已加入轮廓图、矢量阴影、对象调和、封套预设、图片导入、位图调整与离线基础描摹；现有 Electron 制度展板工具继续独立维护。
