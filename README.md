...
> 仓库已新增独立的 [`native/`](native/) 工程：**匠心矢量设计 1.2 Native**。它采用 C++20 与 Qt 6 自主开发，兼容专业图文设计工作流程，但不复制任何 CorelDRAW 专有代码、界面素材或 CDR 文件规范。1.2 已加入段落文字、自动缩字、字体排版、渐变填充、透明度、轮廓样式和快捷色板；现有 Electron 制度展板工具继续独立维护。
