...
> 仓库已新增独立的 [`native/`](native/) 工程：**匠心矢量设计 1.1 Native**。它采用 C++20 与 Qt 6 自主开发，兼容专业图文设计工作流程，但不复制任何 CorelDRAW 专有代码、界面素材或 CDR 文件规范。1.1 已加入贝塞尔节点、六类布尔造型、图层锁定/显隐和图框精确裁剪；现有 Electron 制度展板工具继续独立维护。
