...
> 仓库已新增独立的 [`native/`](native/) 工程：**匠心矢量设计 1.10 Native**。它采用 C++20 与 Qt 6 自主开发，兼容专业图文设计工作流程，但不复制任何 CorelDRAW 专有代码、界面素材或 CDR 文件规范。1.10 聚焦制度板专业文字排版，新增大段文字导入、八点文本框调整、溢出提示、层级样式、多级编号、全板统一格式和安全文字转曲；现有 Electron 制度展板工具继续独立维护。
